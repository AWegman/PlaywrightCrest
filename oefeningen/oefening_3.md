...
- Controleer of het bestand is aangemaakt in je tests folder.
- Actie: Draai de nieuwe tests via de Playwright Sidebar.
...
- Draai de test. Als deze faalt (bijv. omdat een element niet gevonden wordt), switch je naar de agent: @playwright-test-healer.
- Voer de volgende prompt uit om de healer de juiste richting op te sturen:
...
De Healer zal de testcode aanpassen om eerst naar het juiste gedeelte van de pagina te kijken (scoping).
...
Check: Zijn de tests nu groen? En zijn ze robuuster dan de eerste poging?